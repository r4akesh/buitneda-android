...
//        updateProfilePic()
    ...
    open fun setupAccountRv() {
        if (AppSharedPref.isLoggedIn(context!!)) {
            ...
            accountRvData.add(AccountRvModel(AccountRvModel.SUGGESTION, getString(R.string.product_not_found), R.drawable.orders2))
            ...
            accountRvData.add(AccountRvModel(AccountRvModel.AUCTION_PRODUCT, getString(R.string.auction), R.drawable.ic_auction_img_svg))
