...
open class CatalogActivity : BaseActivity() {
    ...
    private fun addEmptyLayout() {
        ...
        fragmentTransaction.add(R.id.catalog_product_list_layout, EmptyFragment.newInstance("empty_cart.json", getString(R.string.empty_product_catalog), getString(R.string.try_different_category_or_search_keyword_maybe),false,"search"), EmptyFragment::class.java.simpleName)
