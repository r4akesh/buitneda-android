    ...
    companion object {
        ...
        fun getSubCategoryList(context: Context, categoryId: String?): Observable<Category> {
            return ApiClient.getClient()!!.create(ApiDetails::class.java).getSubCategoryList(
                AppSharedPref.getStoreId(context), categoryId
            )
        }
        ...
        fun getBrandCatalogProductData(
            context: Context,
            eTag: String,
            type: String,
            brandId: String,
        ...
        fun getAdvanceSearchFormData(
            ...
            return ApiClient.getClient()!!.create(ApiDetails::class.java).getAdvanceSearchFormData(
                eTag, AppSharedPref.getStoreId(context), AppSharedPref.getCurrencyCode(context), 1
            )
        }
        ...
        fun getRatingForData(
            ...
            return ApiClient.getClient()!!.create(ApiDetails::class.java).getRatingForData(
                eTag, AppSharedPref.getStoreId(context)
            )
        }
        ...
        fun forgotPassword(context: Context, email: String): Observable<BaseModel> {
            return ApiClient.getClient()!!.create(ApiDetails::class.java).forgotPassword(
                AppSharedPref.getWebsiteId(context), AppSharedPref.getStoreId(context), email
            )
        }
        ...
        fun getAccountInfo(context: Context, eTag: String): Observable<AccountInfoResponseModel> {
            return ApiClient.getClient()!!.create(ApiDetails::class.java).getAccountInfo(
                eTag, AppSharedPref.getStoreId(context), AppSharedPref.getCustomerToken(context)
            )
        }
        ...
        fun reorder(context: Context, incrementId: String?): Observable<ReOrderModel> {
            ...
            if (AppSharedPref.isLoggedIn(context)) {
                ...
                return ApiClient.getClient()!!.create(ApiDetails::class.java).reorderGuest(
                    AppSharedPref.getStoreId(context), incrementId
                )
            }
        ...
        fun removeFromWishList(
            ...
            return ApiClient.getClient()!!.create(ApiDetails::class.java).removeFromWishList(
                AppSharedPref.getStoreId(context), AppSharedPref.getCustomerToken(context), itemId
            )
        }
        ...
        fun saveProductNotFoundData(
            context: Context,
            multipartFileBody: MultipartBody.Part,
            title: RequestBody,
            email: RequestBody,
            subject: RequestBody,
            message: RequestBody
        ...
        fun addAllToCart(context: Context, qty: JSONObject): Observable<BaseModel> {
            return ApiClient.getClient()!!.create(ApiDetails::class.java).addAllToCart(
                AppSharedPref.getStoreId(context), AppSharedPref.getCustomerToken(context), qty
            )
        }
        ...
        fun uploadProfileImage(
            context: Context,
            profileImageMultipartBody: MultipartBody.Part
        ...
        fun uploadBannerImage(
            context: Context,
            bannerImageMultipartBody: MultipartBody.Part
        ): Observable<ImageUploadResponseData> {
        ...
        fun updateWishList(context: Context, itemData: JSONArray): Observable<BaseModel> {
            return ApiClient.getClient()!!.create(ApiDetails::class.java).updateWishList(
                AppSharedPref.getStoreId(context), AppSharedPref.getCustomerToken(context), itemData
            )
        }
        ...
        fun deleteAddress(context: Context, id: String): Observable<BaseModel> {
            return ApiClient.getClient()!!.create(ApiDetails::class.java).deleteAddress(
                AppSharedPref.getStoreId(context), AppSharedPref.getCustomerToken(context), id
            )
        }
        ...
        fun checkCustomerByEmail(
            ...
            return ApiClient.getClient()!!.create(ApiDetails::class.java).checkCustomerByEmail(
                AppSharedPref.getStoreId(context), email
            )
        }
        ...
        fun logout(context: Context): Observable<BaseModel> {
            return ApiClient.getClient()!!.create(ApiDetails::class.java).logout(
                AppSharedPref.getCustomerToken(context), AppSharedPref.getFcmToken(context)
            )
        }
        ...
        fun getSearchSuggestions(
            ...
            return ApiClient.getClient()!!.create(ApiDetails::class.java).getSearchSuggestions(
                AppSharedPref.getStoreId(context), searchQuery
            )
        }
        ...
        fun getNotificationsList(
            ...
            return ApiClient.getClient()!!.create(ApiDetails::class.java).getNotificationsList(
                eTag, AppSharedPref.getStoreId(context), Utils.screenWidth, Utils.screenDensity
            )
        }
        ...
        fun uploadTokenData(context: Context, token: String?): Observable<BaseModel> {
            return ApiClient.getClient()!!.create(ApiDetails::class.java).uploadTokenData(
                token, AppSharedPref.getCustomerToken(context), DEFAULT_OS
            )
        }
        ...
        fun postContactUs(
            ...
            return ApiClient.getClient()!!.create(ApiDetails::class.java).postContactUs(
                AppSharedPref.getStoreId(context), name, email, telephone, comment
            )
        }
        ...
        fun getGuestOrderDetails(
            ...
            return ApiClient.getClient()!!.create(ApiDetails::class.java).getGuestOrderDetails(
                AppSharedPref.getStoreId(context), type, incrementId, lastName, email, zipCode
            )
        }
        ...
        fun getDeliveryBoyLocation(
            context: Context,
            deliveryboyId: String
        ): Observable<GetDeliveryBoyLocationResponseData> {
            return ApiClient.getClient()!!.create(ApiDetails::class.java)
                .getDeliveryBoyLocation(deliveryboyId)
        }
        ...
        fun saveWalletAccountInfo(
            context: Context,
            accountDetailsResponseData: AccountDetailsResponseData
        ): Observable<BaseModel> {
        ...
        fun sendCode(
            context: Context,/* senderId: String,*/
            receiverId: String,
            amount: String,
            walletNote: String
        ): Observable<SendCodeResponseData> {
            return ApiClient.getClient()!!.create(ApiDetails::class.java).sendCode(
                AppSharedPref.getStoreId(context), AppSharedPref.getCustomerToken(context)
                /*  , senderId*/, receiverId, amount, walletNote
            )
        }
        ...
        fun addBid(
            ...
            auto_auction_opt: Int,
            auto_bid_allowed: String?,
            stop_auction_time_stamp: String?
        ): Observable<BaseModel> {
        ...
        fun getGenerateInvoice(incrementId: String, language: String): Observable<InvoiceModel> {
