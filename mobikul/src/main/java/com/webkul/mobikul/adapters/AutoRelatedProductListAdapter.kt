...
class AutoRelatedProductListAdapter(
    private val mContext: Context,
    private val activity: ProductDetailsActivity,
    private val mListData: ArrayList<ProductTileData>
) : RecyclerView.Adapter<AutoRelatedProductListAdapter.ViewHolder>() {

    override fun onCreateViewHolder(viewGroup: ViewGroup, p1: Int): ViewHolder {
        val view = LayoutInflater.from(mContext)
            .inflate(R.layout.item_auto_related_product, viewGroup, false)
