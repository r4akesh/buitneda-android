 ...
 */
class FeaturedCategoriesRvAdapter(private val mContext: HomeFragment, private val mListData: ArrayList<FeaturedCategory>, val layoutView: Int) : RecyclerView.Adapter<FeaturedCategoriesRvAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return if (layoutView == ConstantsHelper.VIEW_TYPE_LIST) {
            ViewHolder(LayoutInflater.from(mContext.context).inflate(R.layout.item_featured_category, parent, false))
        } else {
