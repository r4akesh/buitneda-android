...
import com.webkul.mobikul.databinding.ItemAuctionHorizontalScrollerProductViewBinding
...
class ProductAuctionHorizontalRvAdapter(
    private val mContext: Context,
    private val mListData: ArrayList<ProductTileData>,
    private val carouselType: String?
) : RecyclerView.Adapter<ProductAuctionHorizontalRvAdapter.ViewHolder>() {

    override fun onCreateViewHolder(viewGroup: ViewGroup, p1: Int): ViewHolder {
        val view = LayoutInflater.from(mContext)
            .inflate(R.layout.item_auction_horizontal_scroller_product_view, viewGroup, false)
...
//        }
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val mBinding: ItemAuctionHorizontalScrollerProductViewBinding? = DataBindingUtil.bind(itemView)
    }
