 ...
 */
class HomePageTopBannerVpAdapter(private val mContext: HomeFragment, private val mListData: ArrayList<BannerImage>?) : PagerAdapter() {

    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        val itemViewPagerBannerBinding = DataBindingUtil.bind<ItemHomeTopBannerViewPagerBinding>(LayoutInflater.from(mContext.context).inflate(R.layout.item_home_top_banner_view_pager, container, false))
