 ...
 */
class HomeFeaturedCategoriesRvAdapter(private val mContext: HomeFragment,
                                      private val mListData: ArrayList<FeaturedCategory>,
                                      val layoutView: Int,
                                      private val carouselType: String) : RecyclerView.Adapter<HomeFeaturedCategoriesRvAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return if (layoutView == ConstantsHelper.VIEW_TYPE_LIST) {
            ...
            val view = LayoutInflater.from(mContext.context).inflate(R.layout.item_featured_category_other_grid, parent, false)
            //view.layoutParams.width = parent.width / 4
            ViewHolder(view)
        }
    }
