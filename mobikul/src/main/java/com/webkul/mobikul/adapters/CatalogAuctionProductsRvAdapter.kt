...
import com.webkul.mobikul.databinding.ItemCatalogAuctionProductGridBinding
...
class CatalogAuctionProductsRvAdapter(private val mContext: CatalogActivity, private val mListData: ArrayList<ProductTileData>) : RecyclerView.Adapter<CatalogAuctionProductsRvAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return if (viewType == VIEW_TYPE_LIST) {
            ...
            ViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_catalog_auction_product_grid, parent, false))
        }
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (getItemViewType(position) == VIEW_TYPE_LIST) {
            ...
            (holder.mBinding as ItemCatalogAuctionProductGridBinding).position = position
            holder.mBinding.data = eachListData
            holder.mBinding.handler = ProductTileHandler(mContext, mListData)
