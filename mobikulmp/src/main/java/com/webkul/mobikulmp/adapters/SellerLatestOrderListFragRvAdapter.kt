 ...
 * @date 28/6/19
 */
class SellerLatestOrderListFragRvAdapter(private val mContext: Context, private val mOrderLists: List<SellerOrderData>) : RecyclerView.Adapter<SellerLatestOrderListFragRvAdapter.ViewHolder>() {
