 ...
 * @date 28/6/19
 */
class SellerLatestOrderListRvAdapter(private val mContext: Context, private val mOrderLists: List<SellerOrderData>) : RecyclerView.Adapter<SellerLatestOrderListRvAdapter.ViewHolder>() {
