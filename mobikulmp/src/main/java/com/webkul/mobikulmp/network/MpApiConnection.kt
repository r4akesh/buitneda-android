    ...
    companion object {
        ...
        fun saveProduct(context: Context, productId: String?, addProductData: AddProductData, imagesData: Map<String, String>): Observable<SaveProductResponseData> {
            return ApiClient.getClient()!!.create(MpApiDetails::class.java).saveProduct(
                    ...
                    addProductData.qty,
                    if (addProductData.isIsInStock) 1 else 0,
                    addProductData.visibility,
                    addProductData.taxClassId,
                    if (addProductData.getProductHasWeight()) 1 else 0,
                    if (addProductData.getProductHasWeight()) addProductData.weight else "0",
                    addProductData.metaTitle,
                    addProductData.metaKeyword,
                    addProductData.metaDescription,
                    ...
                    if (addProductData.isDownloadableProduct) "1" else null,
